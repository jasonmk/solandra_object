module SolandraObject
  module Schema
    class Migration
      ...
      def self.connection
        SolandraObject::Base.connection
      end
      ...
      #
      # http://github.com/twitter/cassandra/blob/master/vendor/0.7/gen-rb/cassandra_types.rb
      #
      ...
      def self.column_family_tasks
        Tasks::ColumnFamily.new(SolandraObject::Base.connection.keyspace)
      end
